...
- While scanning code, if anything looks off (bad/dead code, poor naming, refactor opportunity, or VISION misalignment), immediately log a stand-alone entry in `./docs/BACKLOG.md` so it can be picked up, prioritized, and acted on later.